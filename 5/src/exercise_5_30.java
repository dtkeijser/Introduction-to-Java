...
public class exercise_5_30 {
    public static void main(String[] args) {
        ...
        double currentBallans = deposit * (1 + monthlyInterestRate);


        for (int i = 1; i < numberOfMonths; i++) {
            currentBallans = (currentBallans + deposit) * (1 + monthlyInterestRate);
        }

        System.out.println("After the " + numberOfMonths +
                "th month, the account value is " + currentBallans);
    }
}
